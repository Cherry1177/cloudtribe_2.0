...
CREATE INDEX idx_pending_transfers_new_driver ON pending_transfers(new_driver_id, status);
CREATE INDEX idx_pending_transfers_order ON pending_transfers(order_id);
